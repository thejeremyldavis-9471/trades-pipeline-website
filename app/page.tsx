  ...
  return <><Nav/><main className="bg-[#0b0d0f]">
    ...
    <section className="relative overflow-hidden border-y border-white/10 bg-[#111416] text-white">
      ...
      <div className="relative mx-auto grid max-w-[1500px] items-center gap-8 px-6 py-7 sm:px-10 lg:grid-cols-[.8fr_1.7fr_.7fr] lg:px-12">
        <div className="hidden lg:flex h-32 items-center justify-start overflow-hidden"><img src="/growth-synchronization-blueprint.png" alt="" aria-hidden="true" className="h-full w-auto max-w-full object-contain opacity-55"/></div>
        <div><h2 className="font-display text-[31px] font-bold uppercase leading-none">Growth Synchronization™</h2><p className="mt-3 font-display text-[18px] font-bold leading-[1.2] text-[#ef5b0a]">It's not about making each part better.<br/>It's about making the parts work better together.</p><p className="mt-4 max-w-[620px] text-[13px] leading-[1.6] text-[#e6e4de]">The strongest businesses aren't collections of strong departments. They're connected systems capable of supporting opportunity under pressure.</p></div><div className="font-display text-6xl tracking-[-.22em] text-[#ef5b0a] opacity-85">›››››</div></div>
    </section>
